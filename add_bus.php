...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
    ...
    <link href="font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
     ...
     <?php
                ...
                $sql ="INSERT INTO buses (plate,seats)
                VALUES ('".$_POST["plate"]."','".$_POST["seats"]."')";
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <form role="form" action = "<?php $_PHP_SELF ?>" method="post" enctype="multidata/part"  >
                            ...
                            <div class="col-md-6">
                                <label>Plate</label>
                                <input type="text" class="form-control" name="plate" placeholder="Enter first name">
                            </div>
                            <div class="col-md-6">
                                <label>Seats</label>
                                <input type="text" class="form-control" name="seats" placeholder="Enter Last name">
                            </div>
